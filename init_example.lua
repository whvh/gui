--[[
    Arcanum UI Library - Injection Example
    
    This file is ready for direct injection via loadstring.
    Copy the entire content and inject it into your Roblox executor.
]]

-- For testing with local files, use this:
